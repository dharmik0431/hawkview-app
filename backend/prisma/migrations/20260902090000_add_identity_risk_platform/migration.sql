...
CREATE TABLE "identity_risk_rule_coverage" (
  ...
  "eligible_count_capped" BOOLEAN NOT NULL DEFAULT FALSE, "matched_count_capped" BOOLEAN NOT NULL DEFAULT FALSE,
  "suppressed_count_capped" BOOLEAN NOT NULL DEFAULT FALSE, "not_matched_count_capped" BOOLEAN NOT NULL DEFAULT FALSE,
  "not_evaluated_count_capped" BOOLEAN NOT NULL DEFAULT FALSE,
  ...
  CONSTRAINT "identity_risk_coverage_cap_truth_check" CHECK ((NOT "eligible_count_capped" OR "eligible_count" = 1000000) AND (NOT "matched_count_capped" OR "matched_count" = 1000000) AND (NOT "suppressed_count_capped" OR "suppressed_count" = 1000000) AND (NOT "not_matched_count_capped" OR "not_matched_count" = 1000000) AND (NOT "not_evaluated_count_capped" OR "not_evaluated_count" = 1000000)),
