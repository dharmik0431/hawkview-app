...
export type UnknownObservation =
   ...
   *
   * Renamed from HAWKVIEW_SYNTHETIC_ERROR_CODE, which asserted a provenance
   * this layer cannot substantiate. Behaviour is unchanged: such a code is
   * used neither as a key nor as corroboration. See the note on code 1 in
   * provider-facts for the open question about where it comes from.
   */
