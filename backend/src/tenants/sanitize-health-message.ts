...
/** Safe for tenant-health API DTOs. Preserve allowlisted diagnostic context, never raw credentials or query values. */
export function sanitizeHealthMessage(value: unknown, fallback = 'The latest collection failed.') {
