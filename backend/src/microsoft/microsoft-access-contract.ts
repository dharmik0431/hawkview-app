...
export const MICROSOFT_APPLICATION_PERMISSIONS = [
  ...
  { name: 'IdentityRiskyUser.Read.All', resource: 'MICROSOFT_GRAPH', description: 'Read Microsoft Identity Protection user-risk state without changing or remediating users.', consentMode: 'DEFAULT', connectionRequired: false },
  ...
  { name: 'ReportSettings.Read.All', resource: 'MICROSOFT_GRAPH', description: 'Read whether Microsoft 365 usage reports conceal user, group, and site names. HawkView cannot change this setting.', consentMode: 'DEFAULT', connectionRequired: false },
...
export const MICROSOFT_ACCESS_CAPABILITIES = [
  ...
  { key: 'entra_conditional_access', workloadKey: 'entra_security_configuration', label: 'Conditional Access, authentication strengths, and named locations', tier: 'CORE', applicationPermissions: [{ resource: 'MICROSOFT_GRAPH', name: 'Policy.Read.All' }], licensePrerequisite: 'ENTRA_ID_P1_OR_P2', fallbackCapabilityKey: null, failureScope: 'DATASET_ONLY', resourceTypes: ['CONDITIONAL_ACCESS', 'AUTHENTICATION_STRENGTHS', 'NAMED_LOCATIONS'], endpointPatterns: ['GET /v1.0/identity/conditionalAccess/policies', 'GET /v1.0/policies/authenticationStrengthPolicies', 'GET /v1.0/identity/conditionalAccess/namedLocations'], documentationUrl: 'https://learn.microsoft.com/graph/api/conditionalaccessroot-list-policies' },
  { key: 'entra_security_defaults', workloadKey: 'entra_security_configuration', label: 'Security Defaults', tier: 'CORE', applicationPermissions: [{ resource: 'MICROSOFT_GRAPH', name: 'Policy.Read.All' }], licensePrerequisite: 'NONE', fallbackCapabilityKey: null, failureScope: 'DATASET_ONLY', resourceTypes: ['SECURITY_DEFAULTS'], endpointPatterns: ['GET /v1.0/policies/identitySecurityDefaultsEnforcementPolicy'], documentationUrl: 'https://learn.microsoft.com/graph/api/identitysecuritydefaultsenforcementpolicy-get' },
  { key: 'entra_identity_protection_risky_users', workloadKey: 'entra_identity_protection', label: 'Microsoft Identity Protection user risk', tier: 'CAPABILITY_OPTIONAL', applicationPermissions: [{ resource: 'MICROSOFT_GRAPH', name: 'IdentityRiskyUser.Read.All' }], licensePrerequisite: 'ENTRA_ID_P2', fallbackCapabilityKey: null, failureScope: 'DATASET_ONLY', resourceTypes: ['RISKY_USERS'], endpointPatterns: ['GET /v1.0/identityProtection/riskyUsers'], documentationUrl: 'https://learn.microsoft.com/graph/api/riskyuser-list' },
  ...
  { key: 'sharepoint_usage_reports', workloadKey: 'sharepoint_onedrive', label: 'SharePoint site usage report', tier: 'CAPABILITY_OPTIONAL', applicationPermissions: [{ resource: 'MICROSOFT_GRAPH', name: 'Reports.Read.All' }], licensePrerequisite: 'SHAREPOINT_SERVICE_PLAN', fallbackCapabilityKey: null, failureScope: 'DATASET_ONLY', resourceTypes: ['SHAREPOINT_USAGE'], endpointPatterns: ["GET /v1.0/reports/getSharePointSiteUsageDetail(period='D180')", 'GET {Microsoft Graph report Location URL} (HTTPS, no bearer token)'], documentationUrl: REPORTS_DOCS },
  { key: 'm365_report_privacy_setting', workloadKey: 'sharepoint_onedrive', label: 'Microsoft 365 report privacy setting', tier: 'CAPABILITY_OPTIONAL', applicationPermissions: [{ resource: 'MICROSOFT_GRAPH', name: 'ReportSettings.Read.All' }], licensePrerequisite: 'NONE', fallbackCapabilityKey: null, failureScope: 'DATASET_ONLY', resourceTypes: [], endpointPatterns: ['GET /v1.0/admin/reportSettings?$select=displayConcealedNames'], documentationUrl: 'https://learn.microsoft.com/graph/api/adminreportsettings-get' },
  { key: 'onedrive_usage_reports', workloadKey: 'sharepoint_onedrive', label: 'OneDrive account usage report', tier: 'CAPABILITY_OPTIONAL', applicationPermissions: [{ resource: 'MICROSOFT_GRAPH', name: 'Reports.Read.All' }], licensePrerequisite: 'SHAREPOINT_SERVICE_PLAN', fallbackCapabilityKey: null, failureScope: 'DATASET_ONLY', resourceTypes: ['SHAREPOINT_USAGE'], endpointPatterns: ["GET /v1.0/reports/getOneDriveUsageAccountDetail(period='D30')", 'GET {Microsoft Graph report Location URL} (HTTPS, no bearer token)'], documentationUrl: REPORTS_DOCS },
