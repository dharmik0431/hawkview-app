...
export const MICROSOFT_ACCESS_CAPABILITIES = [
  ...
  { key: 'entra_conditional_access', workloadKey: 'entra_security_configuration', label: 'Conditional Access, authentication strengths, and named locations', tier: 'CORE', applicationPermissions: [{ resource: 'MICROSOFT_GRAPH', name: 'Policy.Read.All' }], licensePrerequisite: 'NONE', fallbackCapabilityKey: null, failureScope: 'DATASET_ONLY', resourceTypes: ['CONDITIONAL_ACCESS', 'AUTHENTICATION_STRENGTHS', 'NAMED_LOCATIONS', 'SECURITY_DEFAULTS'], endpointPatterns: ['GET /v1.0/identity/conditionalAccess/policies', 'GET /v1.0/policies/authenticationStrengthPolicies', 'GET /v1.0/identity/conditionalAccess/namedLocations', 'GET /v1.0/policies/identitySecurityDefaultsEnforcementPolicy'], documentationUrl: 'https://learn.microsoft.com/graph/api/conditionalaccessroot-list-policies' },
