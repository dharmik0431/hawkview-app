...
// Static access is replaced by Next at compile time in both server and client bundles.
export const FRONTEND_BUILD_IDENTITY = parseFrontendBuildIdentity(process.env.NEXT_PUBLIC_HAWKVIEW_BUILD_IDENTITY)
