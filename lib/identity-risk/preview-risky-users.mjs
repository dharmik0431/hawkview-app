...
/** Every customer tenant today: HawkView reporting, Microsoft blocked on P2. */
...
function renderRoute(path) {
  ...
  const identityRiskHooks = {
    useIdentityRiskChannels: () => ({
      ...
      microsoftView: microsoftWithoutP2(),
