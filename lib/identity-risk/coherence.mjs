...
export function accessibleTextPanel(report) {
  ...
  if (report.length === 0) {
    return `<section class="coherence"><h2>Seen versus heard</h2><p>This route renders nothing with a visually-hidden label. That is not a pass — it means the check has no material here.</p></section>`
  }
